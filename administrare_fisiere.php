...
<div class="row">
    ...
    <div class="col-sm-10">
        ...
        <table class="table table-striped table-hover">
            <tr><th>#</th><th>Nume Document</th><th>Descriere Document</th><th>Uploader</th><th>Actiune</th></tr>
            <?php
            for($i=0; $i<100; $i++){
                echo "<tr>";
                echo "<td>".$i."</td>";
                echo "<td>Nume Test</td>";
                echo "<td>Descriere Test</td>";
                echo "<td>Nume Uploader</td>";
                echo "<td><button class='btn btn-danger'>Sterge</button></td>";
                echo "</tr>";
            }
            ?>
        </table>
